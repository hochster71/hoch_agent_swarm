...
//
// HFF — Getting-Paid Speed Report — Stripe Checkout creator.
//
// One plan:
//   - "report" -> $9 ONE-TIME payment (mode: 'payment')
//
// SAFETY (mirrors the proven hff-vendor-spend / hff-hourly-rate shape):
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      metadata: { product: 'hff-payment-timing', tier },
    });
