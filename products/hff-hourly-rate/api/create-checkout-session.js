...
//
// HFF — Effective Hourly Rate Report — Stripe Checkout creator.
//
// One plan:
//   - "report" -> $9 ONE-TIME payment (mode: 'payment')
//
// SAFETY (mirrors the proven hff-runway / hff-client-concentration shape):
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      metadata: { product: 'hff-hourly-rate', tier },
    });
