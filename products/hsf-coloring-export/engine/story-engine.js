/*!
 * HSF Story Engine — VENDORED COPY of hsf/story-engine.js (2026-07-17) for the
 * Coloring Book Export product. Keep in sync with the source if the studio changes.
 *
