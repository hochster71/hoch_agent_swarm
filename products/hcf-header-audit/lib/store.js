// lib/store.js
//
// HCF — Email Header Audit — entitlement key/value store (REAL).
// Ported unchanged in design from the proven hff-runway / hcf-phish-checker
...
//   sess:<checkoutSessionId>  -> one paid audit unlock
'use strict';
