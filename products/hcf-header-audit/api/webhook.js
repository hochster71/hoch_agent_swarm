// api/webhook.js
//
// HCF — Email Header Audit — Stripe webhook handler (REAL entitlement grant).
//
    ...
    switch (event.type) {
      case 'checkout.session.completed': {
        ...
        await setPaid('sess:' + session.id, {
          product: 'hcf-header-audit',
          tier: (session.metadata && session.metadata.tier) || 'audit',
