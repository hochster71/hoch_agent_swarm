// lib/store.js
//
// HFF — Invoice Aging — entitlement key/value store (REAL).
//
// Mirrors the PROVEN hff-runway / hsf store design so the checkout -> webhook ->
// entitlement loop is coherent.
//
// BACKENDS:
...
//
// KEY CONVENTIONS (Invoice Aging is a $9 ONE-TIME purchase, keyed by checkout session):
//   sess:<sessionId>  -> paid:true unlock for that purchase (allows re-download of that report)
//
