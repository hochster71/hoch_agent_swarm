// engine/validate.js
//
// HFF — Recurring Charge Finder — input validation gate. Fails CLOSED with
// machine-readable codes so the API can map them to honest HTTP statuses
// instead of returning a half-built report.
'use strict';
