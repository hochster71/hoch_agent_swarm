// engine/zip.js
//
// Minimal, dependency-free ZIP writer (deflate) so the packager can assemble a
// downloadable pack archive without pulling in an npm dependency. Implements the
// PKZIP local-file + central-directory format with CRC-32 and DEFLATE.
