"""RESTORED 2026-07-20 from 6830e877 (deleted wholesale by a965b0e2 gateway swap while its committed tests remained). Additive executive read-only surface; /health removed here — its contract keys merged into the gateway health route.
